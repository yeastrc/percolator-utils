 ...
 *         &lt;element ref="{http://per-colator.com/percolator_out/14}psm_ids"/>
 *       &lt;/sequence>
 *       &lt;attribute ref="{http://per-colator.com/percolator_out/14}peptide_id use="required""/>
...
public class Peptide implements IPeptide {
    ...
    @XmlAttribute(name = "peptide_id", namespace = "http://per-colator.com/percolator_out/14", required = true)
