 ...
 *         &lt;element ref="{http://per-colator.com/percolator_out/14}q_value_emp" minOccurs="0"/>
 *         &lt;element ref="{http://per-colator.com/percolator_out/14}p_value" minOccurs="0"/>
 *         &lt;element ref="{http://per-colator.com/percolator_out/14}peptide_seq" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *       &lt;attribute ref="{http://per-colator.com/percolator_out/14}protein_id use="required""/>
...
public class Protein implements IProtein {
    ...
    @XmlAttribute(name = "protein_id", namespace = "http://per-colator.com/percolator_out/14", required = true)
