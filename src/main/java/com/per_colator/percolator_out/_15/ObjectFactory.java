 ...
 * generated in the com.per_colator.percolator_out._15 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProteinId_QNAME = new QName("http://per-colator.com/percolator_out/15", "protein_id");
    private final static QName _PValue_QNAME = new QName("http://per-colator.com/percolator_out/15", "p_value");
    private final static QName _CalcMass_QNAME = new QName("http://per-colator.com/percolator_out/15", "calc_mass");
    private final static QName _SvmScore_QNAME = new QName("http://per-colator.com/percolator_out/15", "svm_score");
    private final static QName _QValueEmp_QNAME = new QName("http://per-colator.com/percolator_out/15", "q_value_emp");
    private final static QName _QValue_QNAME = new QName("http://per-colator.com/percolator_out/15", "q_value");
    private final static QName _ExpMass_QNAME = new QName("http://per-colator.com/percolator_out/15", "exp_mass");
    private final static QName _Pep_QNAME = new QName("http://per-colator.com/percolator_out/15", "pep");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.per_colator.percolator_out._15
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "protein_id")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "p_value")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "calc_mass")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "svm_score")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "q_value_emp")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "q_value")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "exp_mass")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/15", name = "pep")
