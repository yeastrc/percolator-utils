 ...
 *         &lt;element ref="{http://per-colator.com/percolator_out/15}peptide_seq"/>
 ...
 *       &lt;/sequence>
 *       &lt;attribute ref="{http://per-colator.com/percolator_out/15}psm_id use="required""/>
...
public class Psm implements IPsm {
    ...
    @XmlAttribute(name = "psm_id", namespace = "http://per-colator.com/percolator_out/15", required = true)
