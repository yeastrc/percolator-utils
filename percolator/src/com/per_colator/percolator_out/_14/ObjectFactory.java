 ...
 * generated in the com.per_colator.percolator_out._14 package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProteinId_QNAME = new QName("http://per-colator.com/percolator_out/14", "protein_id");
    private final static QName _PValue_QNAME = new QName("http://per-colator.com/percolator_out/14", "p_value");
    private final static QName _CalcMass_QNAME = new QName("http://per-colator.com/percolator_out/14", "calc_mass");
    private final static QName _SvmScore_QNAME = new QName("http://per-colator.com/percolator_out/14", "svm_score");
    private final static QName _QValue_QNAME = new QName("http://per-colator.com/percolator_out/14", "q_value");
    private final static QName _QValueEmp_QNAME = new QName("http://per-colator.com/percolator_out/14", "q_value_emp");
    private final static QName _ExpMass_QNAME = new QName("http://per-colator.com/percolator_out/14", "exp_mass");
    private final static QName _Pep_QNAME = new QName("http://per-colator.com/percolator_out/14", "pep");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.per_colator.percolator_out._14
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "protein_id")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "p_value")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "calc_mass")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "svm_score")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "q_value")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "q_value_emp")
    public JAXBElement<String> createQValueEmp(String value) {
        return new JAXBElement<String>(_QValueEmp_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "exp_mass")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://per-colator.com/percolator_out/14", name = "pep")
